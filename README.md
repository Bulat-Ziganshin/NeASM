...
We plan to add virtual registers (a-la PTX), and automatic code reordering.
...
You can preprocess an ASM source file with `python.exe neasm.py example2.neasm >example2.asm`.
